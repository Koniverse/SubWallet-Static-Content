...
在使用收益选项之前，您确认并同意，您通过此功能质押、借出、提供、存入或以其他方式使用的任何数字资产均归您所有或由您合法控制，并且来源合法。

您确认这些资产并非来自犯罪、欺诈、盗窃、腐败、规避制裁、恐怖主义融资、洗钱或任何其他非法活动。您不得使用 SubWallet 收益选项来隐藏、转移、转换或获利于与非法行为有关的资产。

您有责任遵守适用于您的所有法律、法规、税务义务和报告要求，包括反洗钱、反恐怖主义融资、制裁、证券、大宗商品和金融服务规则。如果您所在司法辖区限制或禁止使用收益选项，您不得使用此功能。

SubWallet 是非托管钱包。您需自行对您的资产、账户安全、交易决定、验证人或池的选择、智能合约和协议风险、罚没风险、流动性风险、市场波动、费用、锁定期以及因使用收益选项可能产生的任何损失承担全部责任。奖励、APY、APR 和其他显示数据仅为估算值，不作保证。

在法律、风险控制、第三方提供商或安全考虑要求的情况下，SubWallet 可以阻止、限制、暂停或拒绝您访问收益选项。

继续操作即表示您确认已阅读、理解并同意本收益政策。
