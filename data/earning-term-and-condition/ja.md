...
Earningオプションを利用する前に、あなたは、この機能を通じてステーク、貸付、提供、預入、またはその他の方法で使用するデジタル資産が、あなたにより所有されている、または合法的に管理されており、合法的な出所に由来することを確認し、同意するものとします。

あなたは、これらの資産が犯罪、詐欺、窃盗、汚職、制裁回避、テロ資金供与、マネーロンダリング、またはその他の違法行為による収益ではないことを確認します。違法行為に関連する資産を隠匿、移転、変換、または利益化する目的で、SubWalletのEarningオプションを使用してはなりません。

あなたは、反マネーロンダリング、テロ資金供与対策、制裁、証券、商品、金融サービスに関する規則を含め、あなたに適用されるすべての法律、規制、税務義務、および報告要件を遵守する責任を負います。あなたの法域でEarningオプションの利用が制限または禁止されている場合、この機能を使用してはなりません。

SubWalletは非カストディアルウォレットです。あなたは、資産、アカウントのセキュリティ、取引判断、バリデーターまたはプールの選択、スマートコントラクトおよびプロトコルのリスク、スラッシングリスク、流動性リスク、市場変動、手数料、ロックアップ期間、およびEarningオプションの利用により生じ得る損失について、単独で責任を負います。報酬、APY、APR、およびその他の表示数値は推定値であり、保証されるものではありません。

SubWalletは、法律、リスク管理、第三者プロバイダー、またはセキュリティ上の理由により必要な場合、Earningオプションへのアクセスをブロック、制限、一時停止、または拒否することがあります。

続行することで、あなたは本Earningポリシーを読み、理解し、同意したことを認めるものとします。
