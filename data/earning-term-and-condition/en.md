...
Before using Earning Options, you confirm and agree that any digital assets you stake, lend, provide, deposit, or otherwise use through this feature are owned or lawfully controlled by you and come from legitimate sources.

You confirm that these assets are not proceeds of crime, fraud, theft, corruption, sanctions evasion, terrorist financing, money laundering, or any other unlawful activity. You must not use SubWallet Earning Options to conceal, transfer, convert, or profit from assets connected to illegal conduct.

You are responsible for complying with all laws, regulations, tax obligations, and reporting requirements that apply to you, including anti-money laundering, counter-terrorist financing, sanctions, securities, commodities, and financial services rules. If using Earning Options is restricted or prohibited in your jurisdiction, you must not use this feature.

SubWallet is a non-custodial wallet. You remain solely responsible for your assets, account security, transaction decisions, validator or pool selection, smart contract and protocol risk, slashing risk, liquidity risk, market volatility, fees, lock-up periods, and any loss that may result from using Earning Options. Rewards, APY, APR, and other displayed figures are estimates only and are not guaranteed.

SubWallet may block, limit, suspend, or refuse access to Earning Options where required by law, risk controls, third-party providers, or security considerations.

By continuing, you acknowledge that you have read, understood, and agree to this Earning Policy.
