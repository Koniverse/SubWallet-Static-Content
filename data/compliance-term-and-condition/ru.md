## Полные условия комплаенса

Перед доступом к любым сервисам стейкинга, делегирования, валидаторов, earning, генерации вознаграждений или другим сторонним протокольным сервисам, доступным через SubWallet, вы должны ознакомиться и подтвердить следующее.

Выбирая "Я согласен и продолжить", вы заявляете, гарантируете, признаете и соглашаетесь, что:
